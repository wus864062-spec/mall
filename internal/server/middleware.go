...
func needLogin(ctx context.Context, operation string) bool {
	...
	case userV1.OperationUserServiceGetMe,
		...
		service.OperationUserHTTPGetInvite,
		userV1.OperationUserServiceBindInvite,
		service.OperationUserHTTPNeedInvite,
		walletV1.OperationWalletServiceGetWallet,
		walletV1.OperationWalletServiceRecharge,
		walletV1.OperationWalletServiceListLedger,
		service.OperationWalletHTTPWithdraw,
		service.OperationWalletHTTPSummary,
		service.OperationWalletHTTPRecharge,
		service.OperationWalletHTTPLedger,
		...
		service.OperationOrderHTTPList,
		service.OperationOrderHTTPCart,
		adminV1.OperationAdminServiceGetStats,
		service.OperationAdminHTTPStats,
		...
		service.OperationAdminHTTPListLedger,
		adminV1.OperationAdminServiceForcePairSettle,
		service.OperationAdminHTTPListOrders,
		service.OperationAdminHTTPSearch,
		service.OperationAdminHTTPListGoods,
		service.OperationAdminHTTPCreateProduct,
		service.OperationAdminHTTPUpdateProductMeta,
		service.OperationAdminHTTPListPackages,
		service.OperationAdminHTTPCreatePackage,
		service.OperationAdminHTTPUpdatePackage,
		service.OperationAdminHTTPPackageStatus,
		service.OperationAdminHTTPPackageImage,
		service.OperationAdminHTTPConfig,
		service.OperationAdminHTTPMembers,
		service.OperationAdminHTTPInvitees,
		service.OperationAdminHTTPUserAction,
		service.OperationAdminHTTPClearTestData:
		return true
	default:
		return false
	}
