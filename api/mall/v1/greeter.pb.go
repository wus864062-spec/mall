...
func (x *HelloRequest) Reset() {
	*x = HelloRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mall_v1_greeter_proto_msgTypes[0]
...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return file_mall_v1_greeter_proto_rawDescGZIP(), []int{0}
}
...
func (x *HelloReply) Reset() {
	*x = HelloReply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mall_v1_greeter_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return file_mall_v1_greeter_proto_rawDescGZIP(), []int{1}
}
...
var File_mall_v1_greeter_proto protoreflect.FileDescriptor

var file_mall_v1_greeter_proto_rawDesc = []byte{
...
var (
	file_mall_v1_greeter_proto_rawDescOnce sync.Once
	file_mall_v1_greeter_proto_rawDescData = file_mall_v1_greeter_proto_rawDesc
)

func file_mall_v1_greeter_proto_rawDescGZIP() []byte {
	file_mall_v1_greeter_proto_rawDescOnce.Do(func() {
		file_mall_v1_greeter_proto_rawDescData = protoimpl.X.CompressGZIP(file_mall_v1_greeter_proto_rawDescData)
	})
	return file_mall_v1_greeter_proto_rawDescData
}

var file_mall_v1_greeter_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mall_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: mall.v1.HelloRequest
	(*HelloReply)(nil),   // 1: mall.v1.HelloReply
}
var file_mall_v1_greeter_proto_depIdxs = []int32{
	0, // 0: mall.v1.Greeter.SayHello:input_type -> mall.v1.HelloRequest
	1, // 1: mall.v1.Greeter.SayHello:output_type -> mall.v1.HelloReply
...
func init() { file_mall_v1_greeter_proto_init() }
func file_mall_v1_greeter_proto_init() {
	if File_mall_v1_greeter_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mall_v1_greeter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mall_v1_greeter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mall_v1_greeter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_mall_v1_greeter_proto_goTypes,
		DependencyIndexes: file_mall_v1_greeter_proto_depIdxs,
		MessageInfos:      file_mall_v1_greeter_proto_msgTypes,
	}.Build()
	File_mall_v1_greeter_proto = out.File
	file_mall_v1_greeter_proto_rawDesc = nil
	file_mall_v1_greeter_proto_goTypes = nil
	file_mall_v1_greeter_proto_depIdxs = nil
}
